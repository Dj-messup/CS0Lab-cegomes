...
def main():
    ...
    #FIXED convert string a into integer 
    a = int(a)
    b = int(b)
    #FIXED: convert string b into integer 
    ans=int(a+b)
    print(ans)
    #FIXED: add two numbers and store the result into ans variable
    #FIXED: print the answer as shown as sample ouput 
